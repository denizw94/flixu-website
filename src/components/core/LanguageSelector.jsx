...
export default function LanguageSelector({ currentLang, dict }) {
    ...
    return (
        <div className="relative font-sans" ref={containerRef}>
            ...
            {/* Drop-Up Panel — CSS transition replaces AnimatePresence */}
            <div
                className="absolute bottom-full mb-2 right-0 w-64 bg-white rounded-lg shadow-xl border border-stone-100 overflow-hidden z-50 origin-bottom-right transition-all duration-150"
                style={{
                    opacity: isOpen ? 1 : 0,
