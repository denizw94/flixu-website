            ...
            <div className="flex-1 flex flex-col p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 h-full">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        {/* Abstract Text Lines */}
                        <m.div className="h-2 w-full bg-stone-200 rounded-full" initial={{ width: 0 }} whileInView={{ width: "100%" }} transition={{ duration: 1, delay: 0.5 }} />
                        <m.div className="h-2 w-[90%] bg-stone-200 rounded-full" initial={{ width: 0 }} whileInView={{ width: "90%" }} transition={{ duration: 1, delay: 0.7 }} />

                        {/* THE TRIGGER WORD (Orange Highlight) */}
                        <div className="flex items-center gap-2 mt-1">
                            <m.div className="h-2 w-12 bg-stone-200 rounded-full" initial={{ width: 0 }} whileInView={{ width: 48 }} transition={{ duration: 0.5, delay: 0.9 }} />
                            <m.div
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <m.div className="h-2 w-full bg-stone-200 rounded-full" initial={{ width: 0 }} whileInView={{ width: "100%" }} transition={{ duration: 1, delay: 3.5 }} />
                        <m.div className="h-2 w-[85%] bg-stone-200 rounded-full" initial={{ width: 0 }} whileInView={{ width: "85%" }} transition={{ duration: 1, delay: 3.7 }} />

                        {/* THE CORRECTED WORD */}
                        <div className="flex items-center gap-2 mt-1">
                            <m.div className="h-2 w-10 bg-stone-200 rounded-full" initial={{ width: 0 }} whileInView={{ width: 40 }} transition={{ duration: 0.5, delay: 4 }} />
                            <m.div
