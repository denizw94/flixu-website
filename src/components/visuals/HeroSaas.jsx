  ...
  return (
    <div className="w-full h-full min-h-[400px] flex items-center justify-center bg-[#FDFCF8] relative overflow-hidden pointer-events-none">
      <m.svg width="100%" height="100%" viewBox="0 0 400 300" className="w-full max-w-[500px]">
        ...
        {/* Code Lines */}
        <m.line x1="70" y1="120" x2="160" y2="120" stroke={c.sketch} strokeWidth="1" strokeLinecap="round" variants={draw} initial="hidden" animate="visible" custom={1} />
        ...
        <m.line x1="70" y1="150" x2="140" y2="150" stroke={c.sketch} strokeWidth="1" strokeLinecap="round" variants={draw} initial="hidden" animate="visible" custom={2} />
        ...
        <m.line x1="250" y1="150" x2="330" y2="150" stroke={c.sketch} strokeWidth="1" strokeLinecap="round" variants={draw} initial="hidden" animate="visible" custom={3} />
        
        <m.line x1="70" y1="180" x2="220" y2="180" stroke={c.sketch} strokeWidth="1" strokeLinecap="round" variants={draw} initial="hidden" animate="visible" custom={4} />
      </m.svg>
    </div>
  );
}
