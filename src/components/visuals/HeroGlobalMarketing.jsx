  ...
  return (
    <div className="w-full h-full min-h-[400px] flex items-center justify-center bg-[#FDFCF8] relative overflow-hidden pointer-events-none">
      <m.svg width="100%" height="100%" viewBox="0 0 400 300" className="w-full max-w-[500px]">
        ...
        {/* Internal Hub (HQ) */}
        <m.circle cx="200" cy="150" r="24" fill={c.paper} stroke={c.ink} strokeWidth="1.5" />
        ...
        {[
          ...
          <g key={`region-${i}`}>
            ...
            <m.line x1={node.cx - 8} y1={node.cy - 5} x2={node.cx + 8} y2={node.cy - 5} stroke={c.accent} strokeWidth="1.5" strokeLinecap="round"
            ...
            />
            <m.line x1={node.cx - 8} y1={node.cy + 5} x2={node.cx + 4} y2={node.cy + 5} stroke={c.ink} strokeWidth="1.5" strokeLinecap="round"
        ...
        <m.circle cx="200" cy="150" r="24" fill="transparent" stroke={c.ink} strokeWidth="1"
