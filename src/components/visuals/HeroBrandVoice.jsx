  ...
  return (
    <div className="w-full h-full min-h-[400px] flex items-center justify-center bg-[#FDFCF8] relative overflow-hidden pointer-events-none">
      <m.svg width="100%" height="100%" viewBox="0 0 400 300" className="w-full max-w-[500px]">
        ...
        <m.circle cx="90" cy="130" r="8" fill={c.paper} stroke={c.accent} strokeWidth="1.5"
        ...
        <m.circle cx="90" cy="180" r="8" fill={c.paper} stroke={c.accent} strokeWidth="1.5"
        ...
        <m.circle cx="90" cy="230" r="8" fill={c.paper} stroke={c.accent} strokeWidth="1.5"
        ...
        <m.g animate={{ opacity: [1, 0, 0, 1] }} transition={{ duration: 6, times: [0, 0.2, 0.8, 1], repeat: Infinity }}>
        ...
        <m.g animate={{ opacity: [0, 1, 0, 0] }} transition={{ duration: 6, times: [0, 0.2, 0.5, 0.6], repeat: Infinity }}>
        ...
        <m.g animate={{ opacity: [0, 0, 1, 0] }} transition={{ duration: 6, times: [0, 0.4, 0.6, 1], repeat: Infinity }}>
